...
let jobs = [
    ...
    { "id": 5, "title": "Data Science Intern", "company": "Amazon Development Center", "location": "Hyderabad (On-site)", "salary": "34k-44k", "description": "Work with datasets to build ML models and exploratory analysis.", "applications": [] },
    ...
    { "id": 10, "title": "Security Intern", "company": "Tech Mahindra", "location": "Kolkata (On-site)", "salary": "32k-42k", "description": "Assist in vulnerability assessments and secure coding reviews.", "applications": [] },
    { "id": 11, "title": "Database Intern", "company": "Google India", "location": "Bengaluru (On-site)", "salary": "34k-44k", "description": "Learn database administration tasks for Postgres and MySQL.", "applications": [] },
    ...
    { "id": 16, "title": "Network Engineer Intern", "company": "Tech Mahindra", "location": "Mumbai (On-site)", "salary": "30k-40k", "description": "Support networking tasks and infrastructure troubleshooting.", "applications": [] },
    ...
    { "id": 22, "title": "Business Analyst Intern", "company": "Oracle India", "location": "Bengaluru (On-site)", "salary": "28k-38k", "description": "Analyze business requirements and assist with reports.", "applications": [] },
    ...
    { "id": 33, "title": "Data Analyst", "company": "Google India", "location": "Bengaluru (On-site)", "salary": "45k-60k", "description": "Perform data analysis and build dashboards.", "applications": [] },
    ...
    { "id": 42, "title": "AI Engineer", "company": "Microsoft India", "location": "Bengaluru (On-site)", "salary": "75k-100k", "description": "Build and deploy AI-driven features in production.", "applications": [] },
    { "id": 43, "title": "DevTools Engineer", "company": "Google India", "location": "Noida (On-site)", "salary": "60k-85k", "description": "Create developer tools that boost engineering velocity.", "applications": [] },
    ...
    { "id": 66, "title": "Computer Vision Intern", "company": "Amazon Development Center", "location": "Hyderabad (On-site)", "salary": "38k-54k", "description": "Work on image/video models and pipelines.", "applications": [] },
    ...
    { "id": 73, "title": "SRE (Junior)", "company": "Google India", "location": "Bengaluru (On-site)", "salary": "60k-82k", "description": "Support site reliability and incident management.", "applications": [] },
    ...
    { "id": 80, "title": "Firmware QA", "company": "Samsung R&D", "location": "Kolkata (On-site)", "salary": "42k-56k", "description": "Test firmware releases and hardware interactions.", "applications": [] },
    ...
    { "id": 86, "title": "Edge Computing Engineer", "company": "Wells Fargo India", "location": "Pune (Remote/On-site)", "salary": "64k-88k", "description": "Develop edge-native services and deployments.", "applications": [] },
    ...
    { "id": 97, "title": "Hardware Validation Engineer", "company": "Siemens", "location": "Kolkata (On-site)", "salary": "56k-76k", "description": "Validate hardware designs and run test benches.", "applications": [] },
    { "id": 98, "title": "Network Automation Engineer", "company": "Cisco", "location": "Pune (Remote/On-site)", "salary": "64k-86k", "description": "Automate network configuration and management.", "applications": [] },
    ...
    { "id": 109, "title": "Technical Product Manager", "company": "Google India", "location": "Bengaluru (On-site)", "salary": "90k-125k", "description": "Bridge technical capabilities with business goals, managing the product lifecycle.", "applications": [] },
    ...
    { "id": 112, "title": "Data Engineer (Spark/Kafka)", "company": "L&T Technology Services (LTTS)", "location": "Pune (Remote/On-site)", "salary": "78k-105k", "description": "Build real-time data pipelines using Apache Spark and Kafka.", "applications": [] },
    { "id": 113, "title": "IT Auditor (Security Focus)", "company": "Deloitte", "location": "Ahmedabad (On-site)", "salary": "60k-85k", "description": "Conduct IT audits, ensuring compliance with security standards (ISO, SOC 2).", "applications": [] },
    ...
    { "id": 116, "title": "Machine Learning Engineer (Production)", "company": "Microsoft India", "location": "Bengaluru (On-site)", "salary": "90k-120k", "description": "Move ML models from research to production environments, focusing on MLOps.", "applications": [] },
    ...
    { "id": 118, "title": "Network Administrator", "company": "Cisco", "location": "Chennai (On-site)", "salary": "42k-58k", "description": "Maintain and troubleshoot local and wide area network infrastructure.", "applications": [] },
    ...
    { "id": 122, "title": "ERP Systems Analyst", "company": "Oracle India", "location": "Mumbai (On-site)", "salary": "60k-80k", "description": "Analyze business processes and configure ERP (SAP/Oracle) modules.", "applications": [] },
...
async function renderJobSeekerDashboard(username, container) {
    ...
    const savedJobs = window.jobFeatures ? window.jobFeatures.getSavedJobs() : [];
